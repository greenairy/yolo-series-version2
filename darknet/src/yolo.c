...
{
    char* train_images = "/home/trs/Tiange_workspace/darknet/build/darknet/x64/data/train.txt";
    char* backup_directory = "/home/trs/Tiange_workspace/darknet/build/darknet/x64/backup/";
    srand(time(0));
